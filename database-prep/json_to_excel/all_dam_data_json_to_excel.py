# database-prep/json_to_excel/all_dam_data_json_to_excel.py
...
file_path = './database-prep/all_dam_data.json'
...
output_file_path = './json_to_excel/data/all_dam_data.xlsx'
